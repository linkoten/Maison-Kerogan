...
export default function TheContent() {
  ...
  // Rendu principal du salon de thé
  const renderBlock = (part, paragraphe1, paragraphe2, images, index) => {
    const textContent = (
      <div className="flex flex-col w-full h-full bg-terracotta rounded-xl border-rose border-2 shadow-lg shadow-rose hover:shadow-xl hover:shadow-rose relative overflow-hidden">
    ...
    return (
      <div className="grid px-4 mb-10 space-y-4 grid-cols-1 lg:grid-cols-3 lg:px-0 lg:space-y-0 pt-6 lg:pt-12 transition-all duration-1000">
        {isEven ? (
          <>
            {textContent}
            {carouselContent}
