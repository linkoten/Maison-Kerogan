    ...
    const textContent = (
      <div className="flex flex-col w-full h-full bg-vert rounded-xl border-ocre border-2 shadow-lg shadow-ocre hover:shadow-xl hover:shadow-ocre relative overflow-hidden">
        ...
        <div className="flex flex-col w-full h-full pl-[22%] pr-6 py-4">
          ...
          {/* Bouton de réservation dans le premier bloc uniquement */}
          {index === 0 && (
  ...
  return (
    <div className="container mx-auto">
      <div className="relative pt-24 md:pt-0">
        ...
        <div className="w-24 h-1 bg-gradient-to-r from-transparent via-vert to-transparent mx-auto my-1"></div>
        <div className="w-16 h-1 bg-gradient-to-r from-transparent via-vert to-transparent mx-auto"></div>
      ...
      {/* Bloc Part 4 - Visible toute l'année */}
      {item.part4 &&
        renderBlock(
          item.part4,
